...
export const BADGES: Badge[] = [
  ...
  { id: "early_bird", name: "Early Bird", description: "Complete a trip before 7 AM.", icon: "🌅", goal: 1 },
  ...
  { id: "first_timer", name: "First Timer", description: "Use a new route 5 times.", icon: "🆕", goal: 5 },
  { id: "daily_commuter", name: "Daily Commuter", description: "Use the app for 3 consecutive days.", icon: "📅", goal: 3 },
  { id: "consistent_traveler", name: "Consistent Traveler", description: "Maintain a 7-day streak.", icon: "🔥", goal: 7 },
  ...
  { id: "route_strategist", name: "Route Strategist", description: "Use fastest, cheapest, and shortest modes across 10 trips.", icon: "🧠", goal: 10 },
